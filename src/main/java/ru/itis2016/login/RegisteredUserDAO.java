...
import ru.itis2016.ManagementSystem;
...
public class RegisteredUserDAO {
    ...
    public boolean addUser(RegisteredUser user, String role) throws SQLException {
        Connection connection = ManagementSystem.getInstance().getConnection();
...
//неправильно сделано - сначла кладем связь
    ...
    public boolean updateUser(String oldusername, RegisteredUser user, String new_role, InputStream is) throws SQLException {
        Connection connection = ManagementSystem.getInstance().getConnection();
        log.trace("Connection established");
        try {
            connection.setAutoCommit(false);
